...
A fact mentioned once in passing shouldn't carry the same weight as one repeated a dozen times over six months. [MemoryBank](https://arxiv.org/abs/2305.10250) (Zhong et al., AAAI 2024) applies Ebbinghaus's forgetting curve to LLM memory, where memories decay over time and get reinforced on re-encounter. I took the same idea and made it explicit with a trust score:
